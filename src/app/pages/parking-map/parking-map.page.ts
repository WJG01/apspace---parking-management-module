...
import { MappedSlots, ConsultationSlot, ConsultationHour } from 'src/app/interfaces';
import { Router } from '@angular/router';
import { ModalController } from '@ionic/angular';
import { WsApiService } from 'src/app/services';
import { DateWithTimezonePipe } from 'src/app/shared/date-with-timezone/date-with-timezone.pipe';
import { SlotDetailsModalPage } from '../iconsult/slot-details-modal/slot-details-modal.page';
import { ReviewDeletionModalPage } from '../iconsult/staffs/review-deletion-modal/review-deletion-modal.page';
...
export class ParkingMapPage implements OnInit {
  ...
  doRefresh(ev?) {
    ...
    //         const cssClass = numberOfAvailableAndBookedSlots === numberOfBookedSlots && 
    //         numberOfBookedSlots > 0 ? 'booked' : numberOfBookedSlots > 0 ? 'partially-booked' : numberOfBookedSlots === 0 &&
    //          numberOfAvailableAndBookedSlots !== 0 ? 'available' : null;
